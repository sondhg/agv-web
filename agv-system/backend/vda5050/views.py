...
class AGVViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        ...
        # Only fetch the latest state for each AGV to optimize loading
        # The frontend calls fetchAgvStates for full state history separately
        return queryset
...
class TaskViewSet(viewsets.ViewSet):
    ...
    def create(self, request):
        ...
        winner_agv, error = bid_engine.run_auction(
            pickup_node_id, delivery_node_id, epsilon=epsilon
        )
